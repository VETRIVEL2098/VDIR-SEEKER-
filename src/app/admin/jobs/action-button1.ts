...
.button-container {
 ...
 <mat-icon  data-bs-toggle='modal'   data-bs-target='#companyModal' (click)="view($event)">visibility</mat-icon>
...
export class ActionButtonComponent1 implements ICellRendererAngularComp {
  params: any
